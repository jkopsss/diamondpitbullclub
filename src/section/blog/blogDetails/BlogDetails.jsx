          ...
          <div className="row">
            ...
            <div className="col-lg-8 col-md-12">
              ...
              <div className="blog_post_meta">
                <Link href="# ">
                  <a className="post_author">
                    <img src={avatarIcon.src} alt="blog post avatar" />
                    Inna Mouaz
                  </a>
                </Link>
                <span>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="item-image">
                      <img src={postThumb2.src} alt="blog item thumb" />
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="item-image1">
                      <img src={postThumb3.src} alt="blog item thumb" />
                    </div>
                  </div>
                </div>
                <h4>IGO Facts</h4>
              ...
              <div className="post_tags_list">
                ...
                <div className="share_butn">
                  <Link href="# ">
                    <a onClick={(e) => shareModalHandle(e)}>
                      <FiShare2 /> Share
                    </a>
                  </Link>
                </div>
              ...
              <div className="related_posts_wrapper">
                <Link href="# ">
                  <a className="related_post_item">
                    <img src={postThumb4.src} alt="bithu nft post" />
                ...
                <Link href="# ">
                  <a className="related_post_item next">
                    <img src={postThumb5.src} alt="bithu nft post" />
